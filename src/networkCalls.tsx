...
export const postNewUser = async (
  ...
  try {
    const res = await axios.post(
      "https://api-quiz-unusual.herokuapp.com/user",
      {
        userName: userName,
        score: 0,
      }
...
export const deleteUser = async (
  ...
  try {
    const res = await axios.delete(
      `https://api-quiz-unusual.herokuapp.com/user/${userName}`
    );
...
export const updateUserScore = async (
  ...
  try {
    const res = await axios.post(
      `https://api-quiz-unusual.herokuapp.com/user/${user.userName}`,
      {
...
export const resetUserScore = async (
  user: InitialStateUser,
  userDispatch: (action: ActionUser) => void
) => {
  try {
